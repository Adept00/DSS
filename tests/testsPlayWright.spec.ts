...
test("test", async ({ page }) => {
  ...
  expect(page.locator("li:last-child .field5")).toContainText(new RegExp(date.toString() + "|" + date.toDateString() + "|" + date.toISOString(), "gi"));
  ...
  await page.locator("#saveButton").click();
  expect(page.locator("li:last-child .field5")).toContainText(new RegExp(date2.toString() + "|" + date2.toDateString() + "|" + date2.toISOString(), "gi"));
